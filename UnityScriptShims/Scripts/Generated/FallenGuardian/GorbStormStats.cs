namespace KnightOfNights.Scripts.FallenGuardian
{
    public class GorbStormStats : UnityEngine.MonoBehaviour
    {
        ...
        public float SpokeRotationFinale;
        public float SpokeRotationSmall;
        public float WaitAfterFinale;
        public float WaitAfterTeleport;
        public float WaitBeforeFinale;
        public float WaitBeforeTeleport;
