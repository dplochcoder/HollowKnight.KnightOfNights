...
[PlandoSubmodule]
internal class MarkothModule : AbstractGhostWarriorModule<MarkothModule>
{
    protected override FsmID FsmID() => new("Ghost Warrior Markoth", "Attacking");

    protected override float HPBoost() => 1.65f;
    ...
    protected override void ModifyGhostWarrior(PlayMakerFSM fsm, Wrapped<int> baseHp)
    {
        ...
        Object.Destroy(obj.LocateMyFSM("Rge Check"));
        ...
        void SetPhase3NailWait() => SetNailWait(0.75f, 1.05f);
    ...
    protected override MarkothModule Self() => this;
}
