    ...
    private static string FillDesc(string sceneName)
    {
        switch (sceneName)
        {
            ...
            case SceneNames.Crossroads_04:
                if (!HasWings && !AcquiredLoc(LocationNames.Rancid_Egg_Blue_Lake))
            ...
            case SceneNames.Crossroads_10:
                if (!HasWings && !AcquiredLoc(LocationNames.Boss_Essence_Failed_Champion))
            ...
            case SceneNames.Crossroads_50:
                ...
                break;
            case SceneNames.Deepnest_38:
                if (!HasWings && !AcquiredLoc(LocationNames.Soul_Totem_Deepnest_Vessel))
                ...
                break;
            case SceneNames.Fungus1_09:
                if (HasWings && !AcquiredLoc(LocationNames.Great_Slash))
            ...
            case SceneNames.Fungus1_35:
                if (!PlayerData.instance.GetBool(nameof(PlayerData.hasLantern)))
                ...
                break;
            case SceneNames.Fungus2_01:
                if (!HasWings && !AcquiredLoc(LocationNames.Mask_Shard_Queens_Station))
            ...
            case SceneNames.Fungus2_15:
                if (!HasWings && !AcquiredLoc(LocationNames.Lifeblood_Cocoon_Mantis_Village))
            ...
            case SceneNames.Fungus2_21:
                if (PlayerData.instance.GetBool(nameof(PlayerData.hasCityKey)))
                ...
                break;
            case SceneNames.Fungus2_23:
                if (HasWings && !PlayerData.instance.brettaRescued)
                ...
                break;
            case SceneNames.Fungus3_21:
                if (!HasWings && !AcquiredLoc(LocationNames.Whispering_Root_Greenpath))
            ...
            case SceneNames.Fungus3_22:
                ...
                break;
            case SceneNames.Fungus3_39:
                if (!AcquiredLoc(LocationNames.Love_Key))
            ...
            case SceneNames.Fungus3_archive_02:
                if (HasWings && !AcquiredLoc(LocationNames.Monomon))
            ...
            case SceneNames.GG_Lurker:
                if (HasWings && !AcquiredLoc(LocationNames.Simple_Key_Lurker))
            ...
            case SceneNames.Ruins2_03:
                if (HasWings && !AcquiredLoc(LocationNames.Geo_Chest_Watcher_Knights))
                ...
                break;
            case SummitSceneNames.Summit_BigWindClimb:
            ...
            case SummitSceneNames.Summit_Checkpoint:
            ...
            case SummitSceneNames.Summit_EntryHall:
                return "So it begins. Warriors be with me, it will take much to reach the peak...";
            case SummitSceneNames.Summit_EntryPlain:
            ...
            case SummitSceneNames.Summit_Intermission:
            ...
            case SceneNames.Town:
                ...
                break;
            case SceneNames.Waterways_06:
                if (!HasWings && !AcquiredLoc(LocationNames.Rancid_Egg_Waterways_Main))
            ...
            case SceneNames.Waterways_07:
                if (!HasWings && !AcquiredLoc(LocationNames.Rancid_Egg_Waterways_East))
